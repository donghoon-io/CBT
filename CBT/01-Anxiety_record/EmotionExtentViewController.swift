//
//  EmotionExtentViewController.swift
//  CBT
//
...
class EmotionExtentViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func viewMoreClicked(_ sender: UIButton) {
        let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "EmotionReasonViewController") as! EmotionReasonViewController
